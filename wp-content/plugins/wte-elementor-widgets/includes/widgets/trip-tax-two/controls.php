...
/**
 * Trip Taxonomy 2 Widget Controls.
 *
 * @since 1.3.7
...
$selectors = array(
	...
	// button
	'button_padding'             => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-p: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_margin'              => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_bg_color'            => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-bg: {{VALUE}};',),
	'button_color'               => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-fc: {{VALUE}};',),
	'button_border'              => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card .wpte-card__button',
	'button_border_radius'       => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_boxshadow'           => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card .wpte-card__button',
	'button_bg_hover_color'      => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-bg-h: {{VALUE}};',),
	'button_hover_color'         => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-fc-h: {{VALUE}};',),
	'button_hover_border'        => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card .wpte-card__button:hover',
	'button_hover_border_radius' => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card' => '--b-radius-h: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_hover_boxshadow'     => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-tax_two .wpte-card .wpte-card__button:hover',
);
...
$controls = array(
	...
	'button_section'       => array(
		...
		'condition'    => array('showViewMoreButton' => 'yes', 'cardlayout' => '1'),
		'subcontrols' => array(
